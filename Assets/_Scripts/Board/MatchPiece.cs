...
public class MatchPiece : PoolableObject
{
    ...
    public void DropToTilePosition(Vector3 toPosition)
    {
        ...
        float delay = _dropToTileBaseDelay * (GameConfig.Instance.BoardSize.y - distance + 1f);
    ...
    void StopAnimation()
    {
        ...
        _animation.Stop();
        _transform.localScale = GameConfig.Instance.PieceSize;
    ...
    public void KillPiece(Vector3 position)
    {
        ObjectPooler.Instance.GetObject($"{pieceType}Particle", (Transform trans) =>
        {
            ...
            trans.SetParent(GameConfig.Instance.ParticlesContainer);
